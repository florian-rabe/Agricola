...
/**
 * My highest-scoring game
 *
 * Strategy considerations (details are not always in sync with the actual game play)
 *
 * Round Cards
 ...
 *   In my best game so far I have more than 8 but not 16 Horses.
 ...
 * 
 */
object Best extends Cards with ActionAbbreviations {
  import Square._
